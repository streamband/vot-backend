defmodule VotWeb.UserAuthTest do
  use VotWeb.ConnCase, async: true

  alias Vot.Accounts
  alias VotWeb.UserAuth
  import Vot.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, VotWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      VotWeb.Endpoint.subscribe(live_socket_id)
